...
public:
	...
	virtual std::weak_ptr<GameObject> Create(ObjectType type, std::weak_ptr<ServiceManager> pServiceManager, Vector2D initPosition, float initAngle, float initScale) override;
